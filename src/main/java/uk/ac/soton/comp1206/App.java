...
import uk.ac.soton.comp1206.ui.Options;
...
public class App extends Application {
    ...
    public void start(Stage stage) {
        this.stage = stage;
        communicator = new Communicator("ws://discord.ecs.soton.ac.uk:9500"); //The server is no longer operational!!!
